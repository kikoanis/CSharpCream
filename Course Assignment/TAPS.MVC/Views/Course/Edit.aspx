		...
		<table>
				...
				<tr>
						...
						<td style="width:80%">
								<table>
										<tr>
												<td class="courseName"><%=Html.TextBox("CourseName", null, new
																														{
																																style = "width:70px;",
																																TabIndex = 1,
				...
				<tr>
						...
						<td>
								<table>
										<tr>
												<td class="time"><%=Html.TextBox("StartHour", null, new
																													 {
																															 style = "width:22px",
																															 TabIndex = 9,
																															 onfocus = "this.className = 'Form-Focus';",
												...
												<td class="time"><%=Html.TextBox("StartMinute", null, new
																														 {
																																 style = "width:22px",
																																 TabIndex = 10,
																																 onfocus = "this.className = 'Form-Focus';",
												...
												<td class="time"><%=Html.TextBox("EndHour", null, new
																												 {
																														 style = "width:22px",
																														 TabIndex = 11,
																														 onfocus = "this.className = 'Form-Focus';",
												...
												<td style="width:2px">:</td>
												<td class="time"><%=Html.TextBox("EndMinute", null, new
																													 {
																															 style = "width:22px",
																															 TabIndex = 12,
																															 onfocus = "this.className = 'Form-Focus';",
